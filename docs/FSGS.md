...
## **Pathophysiology** 
  ...
  * Secondary: typically has a known cause 
     1. Pathology: FSGS lesions, with or without  foot process effacement
        - subtotal/partial podocyte foot process effacement (<80% on EM plus or minus glomerulomegaly if hyperfiltration)
     3. Adaptive changes to glomerular hyperfiltration typicallly in the setting of reduced nephron mass (low birth weight, reflux nephropathy, renal dysplasia secondary to other renal disease, oligomeganephronia, sickle cell, age-related FSGS) or normal nephron mass (obesity, DM, HTN, primary glomerular disease)
     4. Direct podocyte injury: HIV, Parvo, CMV, EBV, COVID-19, ect.
     5. Drugs: Bisophosphonates, interferon, mTORi, Heroin, Lithium, Anabolic Steroids
  * Genetic
     ...
     5. Common Genes: NPHS1/2, ACTN 4, TRCP 6, Collagen Alpha Type 3/4/5
  * MCD (Minimal Change Disease) vs FSGS
     1. Hard to distinguish as both have foot process effacement
     ...
     3. If initial dx MCD and does not respond to steroid, consider FSGS
  * Circulating factors currently under investigation for primary FSGS (>50 Genes potentially implicated)
     1. Anti-Nephrin Ab
...
## **Definitions of Treatment Response**
  ...
  * Partial Remission
     ...
     2. Decrease greater than 50% from baseline
  * Relapse
  ...
  * Steroid-dependent FSGS
    1. Relapse occuring during or with in 2wk of completing glucocorticoid therapy
  * CNI-resistent FSGS
  ...
  * CNI-dependent FSGS
    1. Relapse occuring during or with in 2wks of completeing cyclosporine/tacrolimus therapy for >12mo
## **Treatment**
### **Initial treatment**
```mermaid
flowchart TD
