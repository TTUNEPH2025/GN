...
flowchart TD
    ...
    n10 --> n14["Continue supportive Therapy and continue to Monitor PLA2R ab titers"]
    ...
    n22 --> n24
    n20 --> n24
    n24 --> n25["PLA2R Ab negative"] & n26["PLA2R ab Present, but low or decreasing"] & n27["PLA2R ab Persistent"]
    n25 --> n28["• Rituximag --> no additional tx
    • Cyclophosphamide + glucocorticoids --> DC cyclophosphamide taper glucocorticoids
    •CNI --> Taper CNI and glucocorticoids"]
    n27 --> n29["Evaluate PLA2R at 3 or 6 month intervals"]
    n26 --> n29
    n29 --> n30["PLA2R ab negative supportive therapy"] & n31["Persistent"]
    n31 --> n32["Resistent Disease"]
    n32 --> n33["Initial tx
    Rituximab"] & n34["Initial tx
    CNI"] & n35["Initial tx
    Cyclophosphamide"]
    n33 --> n36["eGFR stable"] & n39["eGFR decreasing"]
    n34 --> n37["eGFR stable"] & n40["eGFR decreasing"]
    n36 --> n38["Rituximab + CNI"]
    n35 --> n41["eGFR stable"] & n42["eGFR decreasing"]
    n39 --> n43["Cyclosphosphamide + glucocorticoids"]
    n37 --> n44["Rituximab"]
    n40 --> n45["Cyclosphosphamide + glucocorticoids"]
    n41 --> n46["Rituximab"]
    n42 --> n47["Cyclosphosphamide + glucocorticoids"]
    n43 --> n48["No Rsponse at 3 months"]
    n45 --> n48
    n46 --> n48
    n47 --> n48
    n44 --> n49["Untitled Node"]
    B@{ shape: rect}
```
### Treatment Regimens 
